...
const HomeFeedViagensMeusPassageiro: React.FC = () => {
  ...
  const getFeed = async () => {
    await tripsService.getFeed({ tripDay: 'today', userType: 'passenger' }).then((response) => {
      console.log(response)
      setTodaysTrips(response);
      // console.log(response)
    })

    await tripsService.getFeed({ tripDay: 'not_today', userType: 'passenger' }).then((response) => {
      console.log(response)
