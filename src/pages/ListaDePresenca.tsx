...
import { banOutline, book, bookmark, bookmarkOutline, carOutline, checkmark, checkmarkOutline, closeOutline, documentOutline, documentText, documentTextOutline } from "ionicons/icons";
