    ...
    <IonPage>
      ...
      <IonContent fullscreen>
        <IonHeader collapse="condense">
          <IonToolbar>
            <IonTitle size="large">Minhas viagens</IonTitle>
          </IonToolbar>
        </IonHeader>
        ...
        <IonGrid>
          <IonRow>
            <IonCol>
              <IonButton expand="block" onClick={() => history.push({ pathname: '/vinculo-van-editar' })} fill="outline" color="dark" >
                Maria - Puc Campinas
              </IonButton>
            </IonCol>
          </IonRow>
          ...
          <IonRow>
            <IonCol>
              <IonButton expand="block" onClick={handleLogin} fill="outline" color="dark" >
                João - Unicamp
              </IonButton>
